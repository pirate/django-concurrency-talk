...
> I'm [Nick Sweeting](https://blog.sweeting.me#About) ([@theSquashSH](https://twitter.com/theSquashSH)/[@pirate](https://github.com/pirate)) and I learned these lessons at Monadical, a software consultancy I helped co-found. *Monadical works on resolving distributed systems and concurrency issues daily, and we're hiring engineers all over the world ([apply here](https://monadical.com/apply) or [work with us](https://monadical.com).  We provide full-stack software development, AI-focused angel investing, and CTO-as-a-service work for a wide variety of industries.*
